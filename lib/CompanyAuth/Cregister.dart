// ignore_for_file: unused_local_variable, file_names, use_key_in_widget_constructors
...
class _CompanySignupState extends State<CompanySignup> {
  ...
  Future<void> storeCompanyData() async {
  ...
  Future<void> registerCompany() async {
    try {
      ...
      if (mounted) {
        Navigator.pushNamed(
            context, 'companyRegister'); // Navigate to Company Home page
